...
func (p Page) renderHead(b *element.Builder) any {
	return b.Head().R(
		...
		// CSS
		b.Link("rel", "stylesheet", "href", "/static/css/app.css?v=13"),
...
func (p Page) renderBody(b *element.Builder) any {
	return b.Body().R(
		...
		b.Script("src", "/static/js/app.js?v=15").R(),
		b.Script("src", "/static/js/cats_subcats.js?v=4").R(),
		...
		b.Script("src", "/static/js/summarize.js?v=2").R(),
	)
}
