...
// The ID and timestamps are auto-generated by the database.
...
// GetNoteByID retrieves a single note by its primary key.
...
// GetNoteByGUID retrieves a single note by its GUID.
...
// ListNotes retrieves all non-deleted notes with pagination.
...
// UpdateNote modifies an existing note identified by ID.
...
func UpdateNote(id int64, input NoteInput) (*Note, error) {
	// First verify the note exists and isn't deleted
...
// DeleteNote performs a soft delete by setting deleted_at timestamp.
